...
| Model tools | Kernel **inspect**, **acquire**, **run**; office **sheet** / **deck** / **doc** / **web** after inventory; `toolChoice=auto`; **no SelectionGroup mutation** |
...
| Remote | https://github.com/Player-YN/PawWork-vnext |
