---
name: HTML Preview
description: User wants a long HTML document, profile, article, markdown write-up, or a PDF restyled as a readable page. Do NOT trigger for PPT/幻灯片 (slides) or a clickable 官网 (html-site).
libraries: pawwork:stdlib/html
---

# Document HTML playbook
...
`inspect` the PDF. The host may reconstruct a lookalike HTML page. Treat that as a preview page, not original PDF bytes, not a Design board.
